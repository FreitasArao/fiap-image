...
Usar EventBridge + SNS + SQS para rotear eventos S3 `CompleteMultipartUpload` para processamento:
...
> **Nota**: SNS foi adicionado como intermediário para fan-out e resiliência. Ver ADR 014.
